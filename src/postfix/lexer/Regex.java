...
public class Regex {
	...
	private static final String ID_REGEX = "^([a-zA-Z_][a-zA-Z\\d_]*)$"; // recognizes an id which only have letters (uppercase or not) and starts with a letter or an underscore
